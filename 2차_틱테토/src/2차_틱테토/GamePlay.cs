...
public partial class GamePlay
{
    ...
    public int PlayWithUser(int return_result1, int return_result2)
    {
        ...
        while (true)
        {
            ...
            exitConfirmationNumber = exitConfirmation.JudgeExitCode(user1_num);
            if (exitConfirmationNumber == 0)
            {
                return CHOOSINGMENUAGAIN;
            }
            ...
            exitConfirmationNumber = exitConfirmation.JudgeExitCode(user2_num);
            if (exitConfirmationNumber == 0)
            {
                return CHOOSINGMENUAGAIN;
            }
