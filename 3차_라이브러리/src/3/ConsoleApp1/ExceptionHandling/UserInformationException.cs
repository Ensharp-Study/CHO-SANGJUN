...
public class UserInformationException
{
    ...
    public string JudgeIdWithRegularExpression(int cursorPositionX, int cursorPositionY)
    {
        while (true)
        {
    ...
    public string JudgePasswordWithRegularExpression(int cursorPositionX, int cursorPositionY)
    {
        while (true)
        {
            Console.SetCursorPosition(cursorPositionX, cursorPositionY);
            Console.WriteLine("                                     ");
            Console.SetCursorPosition(cursorPositionX, cursorPositionY);
            string input = informationMasking.MaskPassword();
            string pattern = @"^[a-zA-Z0-9]{8,15}$";
            bool isMatch = Regex.IsMatch(input, pattern);
