...
namespace _4차_LectureTimeTable.ExceptionHandling
{
    public class ToReceiveInput
    {
        ...
        public static string ReceiveInputForMasking(int cursorPositionX, int cursorPositionY) //비밀번호 마스킹 용 입력함수
        {
            StringBuilder stringBuilder = new StringBuilder();
            Console.SetCursorPosition(cursorPositionX, cursorPositionY);
            Console.Write("                                       ");
            ...
            while (true)
            {
                ...
                else if (inputKey.Key == ConsoleKey.Escape) //메뉴 다시 뒤돌아 가기
                {
